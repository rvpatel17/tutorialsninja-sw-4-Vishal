...
public class LaptopsAndNotebooksTest extends TestBase {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        // * 2.20	Fill the mandatory fields
        checkOutPage.enterFirstNameIntoTheFirstNameField("Rudra");
        checkOutPage.enterLastNameIntoTheLastNameField("Patel");
        checkOutPage.enterEmailIntoTheEmailField("Rudrapatel@gmail.com");
        checkOutPage.enterTelephoneIntoTheTelephoneField("9184561234");
        checkOutPage.enterAddressIntoTheAddress1Field("2598 143th street");
